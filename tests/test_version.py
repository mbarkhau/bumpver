...
def test_bump_random(monkeypatch):
    ...
    for _ in range(1000):
        ...
        new_version = v1version.incr(
            cur_version,
            tag=random.choice([None, "alpha", "beta", "rc", "final", "post"]),
        )
        assert cur_version < new_version
...
PARSE_V1_VERSION_TEST_CASES = [
    ...
    [
        "{year}.{month}.{dom_short}",
        "2017.06.7",
        v1vnfo(year="2017", month="06", dom="7"),
    ],
    [
        "{year}.{month}.{dom_short}",
        "2017.06.7",
    ...
    [
        "{year}.{month_short}.{dom_short}",
        "2017.6.7",
        v1vnfo(year="2017", month="6", dom="7"),
    ],
    ...
    [
        "{year}.{month_short}.{MINOR}",
        "2017.6.7",
        v1vnfo(year="2017", month="6", minor="7"),
    ],
    ["{year}.{month}.{MINOR}", "2017.06.7", v1vnfo(year="2017", month="06", minor="7")],
    [
        "{year}.{month}.{MINOR}",
        "2017.06.07",
        v1vnfo(year="2017", month="06", minor="07"),
    ],
...
@pytest.mark.parametrize(
    "pattern_str, line, expected_vinfo", PARSE_V1_VERSION_TEST_CASES
)
