...
"""Rewrite files, updating occurrences of version strings."""
...
def rewrite_lines(
    ...
    """Replace occurrences of patterns in old_lines with new_vinfo."""
...
def rewrite_files(
    ...
    for file_data in iter_rewritten(file_patterns, new_vinfo):
        ...
        with open(file_data.path, mode="w", encoding="utf-8") as fobj:
